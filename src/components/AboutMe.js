      ...
      <div class='text-center mt-20 c-first dark:bg-dark'>
        <div class='md:flex  '>
          <div class='flex-1 m-auto'>
            <img
              src='https://i.ibb.co/whcvS3r/beck-3.png'
              alt=''
              class=' w-72 mb-6 md:w-96  rounded-lg border-yellow-400 border-b-4 m-auto wow animate__animated animate__fadeInLeft'
            />
          </div>
          <div class='pl-4 pr-4 md:flex-1 m-auto  md:text-left dark:text-white'>
            <h1 class='wow animate__animated animate__fadeInDown   mb-9 font-bold rounded-lg  tracking-widest  text-transparent bg-clip-text bg-gradient-to-br from-yellow-400 to-red-600'>
              ABOUT ME{' '}
            </h1>

            <h1 class='text-5xl  md:text-5xl '>Who I am? </h1>

            <p className='md:w-11/12 md:text-xl  mt-5 mb-5 wow animate__animated animate__fadeInRight '>
              My name is <b className='text-yellow-500'>Bryan Escobar</b>, I am
              a creactive person who loves challenges and does not give up
              easily. Very detailed, I never stop learning, web developer and
              lover from frontend world.{' '}
              <a href='/projects' className='text-yellow-500 font-bold'>
                See my projects here
              </a>
            </p>

            <h1 class='text-5xl md:text-5xl flex-initial mb-4 wow animate__animated animate__fadeInRight'>
                  ...
                  <ul className='mb-5 md:flex '>
                    ...
                    <div className='flex flex-1 mr-4 ml-4 rounded-xl md:mb-2  mb-8  '>
                      <div className='flex flex-col w-full shadow-2xl rounded-2xl overflow-hidden no-underline dark:border-yellow-500 border-2  transform transition duration-500 hover:scale-105 cursor-pointer'>
                        ...
                        <div className='px-2   py-2 text-center'>
                          <h5 className='dark:text-white font-bold text-2xl'>
                            Course Web development usign C# ASP.Net with
                            .NetFramework
                          </h5>
                          <br />
                          <h5 className='dark:text-white'>
                            Cámara Salvadoreña de Tecnologías de la Información
                            y Comunicaciones (CASATIC)
                          </h5>
                        </div>
                      </div>
                    </div>
